                ...
                {loading ? (
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <button
                            ...
                            disabled={signingIn}
                            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-black rounded-2xl font-bold text-white hover:bg-gray-900 active:scale-[0.98] transition-all"
                        >
