        ...
        <section className="experience-section py-32 bg-gradient-to-br from-[#A1887F] to-[#EFEBE9]">
            <div className="container mx-auto px-8 max-w-7xl">
                <div className="text-center mb-16">
                    <h2 className="text-5xl font-black mb-4 font-sans text-[#3E2723]">La Experiencia Bloom</h2>
                    <p className="text-2xl italic text-[#3E2723]/70 font-sans">Cada visita es un viaje sensorial</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[300px] gap-6">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 className="text-3xl font-bold text-[#D4AF37] mb-2 font-sans">Ambiente Acogedor</h3>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 className="text-xl font-bold text-[#D4AF37] font-sans">Arte en Cada Taza</h3>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 className="text-xl font-bold text-[#D4AF37] font-sans">Pastelería Fresca</h3>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                            <div>
                                <h3 className="text-2xl font-bold text-[#D4AF37] mb-2 font-sans">Granos Premium</h3>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3E2723]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                            <h3 className="text-xl font-bold text-[#D4AF37] font-sans">Maestros Baristas</h3>
                        </div>
                    </motion.div>
                </div>
            </div>
